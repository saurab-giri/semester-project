    ...
    <h3 class="text-center head">Add New Client</h3>
      <table align="center">
       <tr><td>Name:</td><td><input type="text" name="name" class="form-control" required /></td></tr>
        ...
        <tr><td>Age:</td><td><input type="text" name="age" class="form-control" required /></td></tr>
        <tr><td>Phone:</td><td><input type="text" name="phone" class="form-control" required /></td>
        <td class="msg"><?php
        ...
        <tr><td>Email:</td><td><input type="text" name="email" class="form-control" required /></td>
      ...
      <tr>
        ...
        <tr><td></td><td><br><input type="submit" name="add_client" value="Add Client" class="btn btn-info"/></td></tr>
      </table>  
      </div>
</form>
